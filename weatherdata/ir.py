...
# Explicitly set the directory to weatherdata/Ir
BASE_DIR = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
IMG_DIR = os.path.join(BASE_DIR, "weatherdata", "Ir")
...
def fetch_tile(z, x, y):
    url = f"http://mesonet.agron.iastate.edu/cache/tile.py/1.0.0/goes-east-ir-4km/{z}/{x}/{y}.png"
...
def save_conus_snapshot():
    ...
    print(f"Saved CONUS IR snapshot as {filepath} ({OUT_WIDTH}x{OUT_HEIGHT})")
